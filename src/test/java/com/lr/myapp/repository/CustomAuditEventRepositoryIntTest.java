...
import com.lr.myapp.config.audit.AuditEventConverter;
import com.lr.myapp.domain.PersistentAuditEvent;
...
import static com.lr.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
